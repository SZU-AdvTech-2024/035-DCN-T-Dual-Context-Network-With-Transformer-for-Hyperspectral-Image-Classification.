...
__all__ = [
    'VGG', 'vgg16_bn'  # , 'vgg19_bn', 'vgg19', 'vgg11', 'vgg11_bn', 'vgg13', 'vgg13_bn', 'vgg16'
]
...
def make_layers(cfg, in_channels, batch_norm=False):  # cfg['D']; 3; True
    layers = []
    for v in cfg:
        if v == 'M':
...
def vgg16_bn(args, in_channels, pretrained=True, **kwargs):
    ...
    if pretrained:
        model_path = '/home2/lzn/project/DCN-T/vgg16_bn-6c64b313.pth'
